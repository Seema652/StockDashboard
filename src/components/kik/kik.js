...
const KikPage = () => {
  const [selectedChat, setSelectedChat] = useState(0);
        ...
        const contacts = [
          { name: "Marisol", lastMsg: "LMK what you think", time: "12:07 PM" },
          { name: "Liam", lastMsg: "See ya", time: "10:02 PM" },
          { name: "Chat with Klaus", lastMsg: "cool 👍", time: "10:52 PM" },
          { name: "Mandy", lastMsg: "thanks!", time: "8:04 PM" },
        ];
      
        const chats = [
          [
            { from: "Marisol", text: "Have you seen the latest episode of Stranger Things?", time: "11:31 AM", date: "Yesterday" },
            { from: "You", text: "No, not yet", time: "11:46 AM", date: "Yesterday" },
            { from: "Marisol", text: "Is it good?", time: "12:02 PM", date: "Yesterday" },
            { from: "You", text: "It's amazing! You need to watch it ASAP", time: "12:04 PM", date: "Yesterday" },
            { from: "Marisol", text: "Okay, I'll watch it tonight", time: "12:05 PM", date: "Yesterday" },
            { from: "Marisol", text: "LMK what you think", time: "12:07 PM", date: "Yesterday" },
          ],
          [
            { from: "Liam", text: "See ya", time: "10:02 PM", date: "Yesterday" },
          ],
          [
            { from: "Chat with Klaus", text: "cool 👍", time: "10:52 PM", date: "Yesterday" },
          ],
          [
            { from: "Mandy", text: "thanks!", time: "8:04 PM", date: "Yesterday" },
          ],
        ];
  ...
  return (
    <div className="container-fluid vh-100 p-0" style={{ backgroundColor: "#f0f0f0", color: "black" }}>
      <div className="p-3">
        <h1 className="fw-bold fs-1">Kik</h1>
      </div>
