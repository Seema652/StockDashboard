...
const ViberPage = () => {
  ...
  const contacts = [
    { name: "Marzia", lastMsg: "this Saturday", time: "4:33 PM", date: "2024-12-21" },
    { name: "Frank", lastMsg: "booking them now", time: "10:58 AM", date: "2024-12-21" },
    { name: "Amanda", lastMsg: "so you can come over", time: "4:56 PM", date: "2024-12-21" },
  ];

  const chats = [
    [
      { from: "Marzia", text: "Why aren't you picking up?", time: "11:42 AM", date: "2024-12-21" },
      { from: "Marzia", text: "Is everything okay there?", time: "11:43 AM", date: "2024-12-21" },
      { from: "You", text: "everything's fine", time: "11:44 AM", date: "2024-12-21" },
      { from: "You", text: "I talked to Klaus and he's still up for it", time: "11:45 AM", date: "2024-12-21" },
      { from: "Marzia", text: "When are you going?", time: "4:31 PM", date: "2024-12-21" },
      { from: "You", text: "this Saturday", time: "4:33 PM", date: "2024-12-21" },
    ],
    [
      { from: "Frank", text: "booking them now", time: "10:58 AM", date: "2024-12-21" },
    ],
    [
      { from: "Amanda", text: "so you can come over", time: "4:56 PM", date: "2024-12-21" },
    ],
  ];
  ...
  return (
    <div className="container-fluid vh-100 p-0" style={{ backgroundColor: "#f0f0f0", color: "black" }}>
      <div className="p-3">
        <h1 className="fw-bold fs-1">Viber</h1>
      </div>
