...
const DiscordPage = () => {
  ...
  const contacts = [
    { name: "amanda", lastMsg: "You should", time: "3:48 PM" },
    { name: "tomas_anderson", lastMsg: "Bro, this meme is gol...", time: "5:52 PM" },
    { name: "klaus.football", lastMsg: "I know, they killed it", time: "5:44 PM" },
  ];

  const chats = [
    [
      { from: "amanda", text: "Have you tried that viral pasta recipe?", time: "3:42 PM" },
      { from: "You", text: "Not yet, but it looks delicious", time: "3:43 PM" },
      { from: "amanda", text: "You should", time: "3:45 PM" },
      { from: "You", text: "Alright, I’m convinced", time: "3:47 PM" },
      { from: "amanda", text: "It’s super easy and tastes amazing", time: "3:46 PM" },
      { from: "amanda", text: "LYK how it turns out", time: "3:48 PM" },
    ],
  ]
  ...
  return (
    <div className="container-fluid vh-100 p-0" style={{ backgroundColor: "#f0f0f0", color: "black" }}>
      <div className="p-3">
        <h1 className="fw-bold fs-1">Discord</h1>
      </div>
