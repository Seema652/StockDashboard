...
const HangoutsPage = () => {
  ...
  const contacts = [
    { name: "Vincent Copeland", lastMsg: "of course", time: "4:23 PM" },
    { name: "Darryl Black", lastMsg: "I'll stop by tomorrow", time: "3:13 PM" },
  ];

  const chats = [
    [
      { from: "Vincent Copeland", text: "Hello, Eric. Just reminding you that we have an appointment on Friday, don't forget about it again.", time: "4:18 PM" },
      { from: "You", text: "hi, doc", time: "4:19 PM" },
      { from: "You", text: "yes, I'll be there, thanks", time: "4:20 PM" },
      { from: "Vincent Copeland", text: "And don't forget that you're not allowed to eat anything before the tests.", time: "4:22 PM" },
      { from: "You", text: "of course", time: "4:23 PM" },
    ],
  ]
  ...
  return (
    <div className="container-fluid vh-100 p-0" style={{ backgroundColor: "#f0f0f0", color: "black" }}>
      <div className="p-3">
        <h1 className="fw-bold fs-1">Hangouts</h1>
      </div>
